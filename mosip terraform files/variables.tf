variable "sandbox_name" { //Change this to your sandbox name.
  default = "digitalid-lgcc"  // This is informational.  A tag will be added with this name.
}
...
variable "private_key" {
  type = map(string)
  default = {
    "name" = "mossip-aws"  // Name as given while creating keys on AWS console 
    "local_path" = "~/.ssh/mossip-aws.pem" // Location on the machine from where you are running terraform
  } 
}
